          ...
          <div className='flex space-x-4'>
            ...
            <div hidden className='md:block'>
              <div className='relative flex items-center text-gray-400 focus-within:text-cyan-400'>
                <span className='absolute left-4 h-6 flex items-center pr-3 border-r border-cyan-300'>
                  <svg
                ...
                <input
                  ...
                  className='w-full pl-14 pr-4 py-2.5 rounded-xl text-sm text-gray-600 outline-none border border-cyan-300 focus:border-cyan-300 transition'
                />
              </div>
            </div>
            {/* search bar */}
